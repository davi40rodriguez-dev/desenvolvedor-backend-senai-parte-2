...
namespace SistemaBancario.Classes.Contextos
{
    internal class BancoContext : DbContext
    {
        ...
        /// </summary>
        public DbSet<Banco> Contas { get; set; } = null!;

        //Métodos
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            // Usando SQLServer  
            optionsBuilder.UseSqlServer(@"Server=ECFP507D1319386\SQLEXPRESS;Database=Banco;Trusted_Connection=True;TrustServerCertificate=True;");
        }
